...
export const jlptGrammar: JlptGrammarPoint[] = [
  ...
  { level: 5, jp: "〜てください", en: "please do", lessonId: "making-requests" },
  ...
  { level: 5, jp: "〜が・〜けど", en: "but / although", lessonId: null },
  { level: 5, jp: "〜てから", en: "after doing", lessonId: null },
  { level: 5, jp: "もう・まだ", en: "already / still", lessonId: null },
  { level: 5, jp: "あまり〜ない", en: "not much / not very", lessonId: null },
  { level: 5, jp: "〜がある・〜がいる", en: "existence", lessonId: null },
  ...
  { level: 4, jp: "〜ば", en: "if (conditional)", lessonId: "conditionals" },
  { level: 4, jp: "〜たら", en: "if / when (conditional)", lessonId: "conditionals" },
  { level: 4, jp: "〜なら", en: "if (contextual)", lessonId: "conditionals" },
  { level: 4, jp: "〜と（条件）", en: "natural consequence", lessonId: "conditionals" },
  { level: 4, jp: "使役形（〜させる）", en: "causative", lessonId: "causative-passive" },
  { level: 4, jp: "受身形（〜られる）", en: "passive", lessonId: "causative-passive" },
  ...
  { level: 4, jp: "〜ても・〜でも", en: "even if", lessonId: "hypothesizing" },
  { level: 4, jp: "〜と言う・〜と思う", en: "quoting speech & thought", lessonId: "quoted-speech" },
  { level: 4, jp: "意向形（〜よう）", en: "volitional — let's / shall", lessonId: "advanced-volitional" },
  ...
  { level: 4, jp: "〜ておく", en: "do in advance", lessonId: null },
  { level: 4, jp: "〜てある", en: "resulting state (set up)", lessonId: null },
  { level: 4, jp: "〜てほしい", en: "want someone to do", lessonId: null },
  { level: 4, jp: "〜つもり", en: "intention", lessonId: null },
  { level: 4, jp: "〜ため（に）", en: "for the sake of", lessonId: null },
  { level: 4, jp: "〜のに", en: "despite", lessonId: null },
  { level: 4, jp: "〜し", en: "listing reasons", lessonId: null },
];
