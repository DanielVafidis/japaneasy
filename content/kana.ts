...
export interface KanaChar {
  ...
  romaji: string;
  type: KanaType;
  /** Standard stroke counts as [hiragana, katakana] (gojuon only). */
  strokes?: [number, number];
}

export const gojuon: KanaChar[] = [
  { hira: "あ", kata: "ア", romaji: "a", type: "gojuon", strokes: [3, 2] },
  { hira: "い", kata: "イ", romaji: "i", type: "gojuon", strokes: [2, 2] },
  { hira: "う", kata: "ウ", romaji: "u", type: "gojuon", strokes: [2, 3] },
  { hira: "え", kata: "エ", romaji: "e", type: "gojuon", strokes: [2, 3] },
  { hira: "お", kata: "オ", romaji: "o", type: "gojuon", strokes: [3, 3] },
  { hira: "か", kata: "カ", romaji: "ka", type: "gojuon", strokes: [3, 2] },
  { hira: "き", kata: "キ", romaji: "ki", type: "gojuon", strokes: [4, 3] },
  { hira: "く", kata: "ク", romaji: "ku", type: "gojuon", strokes: [1, 2] },
  { hira: "け", kata: "ケ", romaji: "ke", type: "gojuon", strokes: [3, 3] },
  { hira: "こ", kata: "コ", romaji: "ko", type: "gojuon", strokes: [2, 2] },
  { hira: "さ", kata: "サ", romaji: "sa", type: "gojuon", strokes: [3, 3] },
  { hira: "し", kata: "シ", romaji: "shi", type: "gojuon", strokes: [1, 3] },
  { hira: "す", kata: "ス", romaji: "su", type: "gojuon", strokes: [2, 2] },
  { hira: "せ", kata: "セ", romaji: "se", type: "gojuon", strokes: [3, 2] },
  { hira: "そ", kata: "ソ", romaji: "so", type: "gojuon", strokes: [1, 2] },
  { hira: "た", kata: "タ", romaji: "ta", type: "gojuon", strokes: [4, 3] },
  { hira: "ち", kata: "チ", romaji: "chi", type: "gojuon", strokes: [2, 3] },
  { hira: "つ", kata: "ツ", romaji: "tsu", type: "gojuon", strokes: [1, 3] },
  { hira: "て", kata: "テ", romaji: "te", type: "gojuon", strokes: [1, 3] },
  { hira: "と", kata: "ト", romaji: "to", type: "gojuon", strokes: [2, 2] },
  { hira: "な", kata: "ナ", romaji: "na", type: "gojuon", strokes: [4, 2] },
  { hira: "に", kata: "ニ", romaji: "ni", type: "gojuon", strokes: [3, 2] },
  { hira: "ぬ", kata: "ヌ", romaji: "nu", type: "gojuon", strokes: [2, 2] },
  { hira: "ね", kata: "ネ", romaji: "ne", type: "gojuon", strokes: [2, 4] },
  { hira: "の", kata: "ノ", romaji: "no", type: "gojuon", strokes: [1, 1] },
  { hira: "は", kata: "ハ", romaji: "ha", type: "gojuon", strokes: [3, 2] },
  { hira: "ひ", kata: "ヒ", romaji: "hi", type: "gojuon", strokes: [1, 2] },
  { hira: "ふ", kata: "フ", romaji: "fu", type: "gojuon", strokes: [4, 1] },
  { hira: "へ", kata: "ヘ", romaji: "he", type: "gojuon", strokes: [1, 1] },
  { hira: "ほ", kata: "ホ", romaji: "ho", type: "gojuon", strokes: [4, 4] },
  { hira: "ま", kata: "マ", romaji: "ma", type: "gojuon", strokes: [3, 2] },
  { hira: "み", kata: "ミ", romaji: "mi", type: "gojuon", strokes: [2, 3] },
  { hira: "む", kata: "ム", romaji: "mu", type: "gojuon", strokes: [3, 2] },
  { hira: "め", kata: "メ", romaji: "me", type: "gojuon", strokes: [2, 2] },
  { hira: "も", kata: "モ", romaji: "mo", type: "gojuon", strokes: [3, 3] },
  { hira: "や", kata: "ヤ", romaji: "ya", type: "gojuon", strokes: [3, 2] },
  { hira: "ゆ", kata: "ユ", romaji: "yu", type: "gojuon", strokes: [2, 2] },
  { hira: "よ", kata: "ヨ", romaji: "yo", type: "gojuon", strokes: [2, 3] },
  { hira: "ら", kata: "ラ", romaji: "ra", type: "gojuon", strokes: [2, 2] },
  { hira: "り", kata: "リ", romaji: "ri", type: "gojuon", strokes: [2, 2] },
  { hira: "る", kata: "ル", romaji: "ru", type: "gojuon", strokes: [1, 2] },
  { hira: "れ", kata: "レ", romaji: "re", type: "gojuon", strokes: [2, 1] },
  { hira: "ろ", kata: "ロ", romaji: "ro", type: "gojuon", strokes: [1, 3] },
  { hira: "わ", kata: "ワ", romaji: "wa", type: "gojuon", strokes: [2, 2] },
  { hira: "を", kata: "ヲ", romaji: "wo", type: "gojuon", strokes: [3, 3] },
  { hira: "ん", kata: "ン", romaji: "n", type: "gojuon", strokes: [1, 2] },
];
