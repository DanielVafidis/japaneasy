...
export const pdfSections: Record<string, PdfSection[]> = {
  ...
  "essential-grammar": [
    { pdfPages: "96-102", title: "Polite form & verb stems", status: "partial", lessonId: "polite-form" },
    ...
    { pdfPages: "112-119", title: "The question marker", status: "partial", lessonId: "questions-polite" },
    ...
    { pdfPages: "144-156", title: "Potential form", status: "partial", lessonId: "potential-form" },
    { pdfPages: "157-167", title: "Conditionals", status: "partial", lessonId: "conditionals" },
    { pdfPages: "168-175", title: "Must / have to", status: "partial", lessonId: "obligation" },
    { pdfPages: "176-184", title: "Desire & suggestions", status: "partial", lessonId: "desire-suggestions" },
    { pdfPages: "185-199", title: "Defining, trying & quotes", status: "partial", lessonId: "defining-and-trying" },
    { pdfPages: "185-199", title: "Quoted speech & って", status: "done", lessonId: "quoted-speech" },
    { pdfPages: "204-211", title: "Giving & receiving", status: "partial", lessonId: "giving-receiving" },
    ...
    { pdfPages: "100-104", title: "Te-form conjugation & requests", status: "partial", lessonId: "te-form" },
  ],
  "special-expressions": [
    ...
    { pdfPages: "282-286", title: "Generic nouns (こと・の)", status: "done", lessonId: "generic-nouns" },
    ...
    { pdfPages: "342-352", title: "Hypothesizing & concluding", status: "done", lessonId: "hypothesizing" },
    { pdfPages: "353-363", title: "Time & leaving as-is", status: "done", lessonId: "time-and-mama" },
  ],
  "advanced-topics": [
    { pdfPages: "365-371", title: "Formal expressions (である)", status: "done", lessonId: "formal-dearu" },
    { pdfPages: "371-383", title: "はず・べき・べきではない", status: "done", lessonId: "hazu-beki" },
    { pdfPages: "394-407", title: "ざるを得ない & tendencies", status: "done", lessonId: "zaru-wo-enai" },
    { pdfPages: "400-407", title: "がち・つつ", status: "done", lessonId: "tendencies" },
    { pdfPages: "384-393", title: "Showing signs of something", status: "done", lessonId: "showing-signs" },
    { pdfPages: "408-417", title: "Advanced volitional", status: "done", lessonId: "advanced-volitional" },
    { pdfPages: "418-435", title: "Covered by / immediate events / other", status: "done", lessonId: "covered-events" },
    { pdfPages: "366-370", title: "でさえ・ですら", status: "done", lessonId: "de-sae-desura" },
  ],
};
